...
const SOCIALS = [
  ...
  {
    label: 'Email',
    href: 'mailto:faheem@faheemulislam.com',
    icon: (
...
export default function Contact() {
  ...
  function handleSubmit(e) {
    ...
    window.location.href = `mailto:faheem@faheemulislam.com?subject=Portfolio contact from ${name.value}&body=${encodeURIComponent(message.value)}%0A%0AFrom: ${name.value} <${email.value}>`
    setSent(true)
  }
